...
public class WebMagicDemo03 implements PageProcessor {
    ...
    public static void main(String[] args) {
        ...
        // 创建 spider
        Spider spider = Spider.create(new WebMagicDemo03());
        ...
        // 创建 filePipeline
        FilePipeline filePipeline = new MyFilePipeline2();
        // 设置存放路径
        filePipeline.setPath("E:\\web-magic-03\\download-page");
        // Spider 设置 pipeline
 ...
 * 继承 FilePipeline
 */
class MyFilePipeline2 extends FilePipeline {
